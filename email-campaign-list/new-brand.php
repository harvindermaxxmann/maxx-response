...
<div class="row-fluid">
    ...
    <div class="span5">
		<div class="new-brand-sec">
    	<h2><?php echo _('New brand');?></h2>
		<div class="input-row">
			<div class="input-box">
