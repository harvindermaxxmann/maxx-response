...
<div class="row-fluid">
    ...
    <div class="span10" >
	<div class="report-sec-box">
    	<div class="head-sec-report">
			<h2><?php echo _('Campaign report');?></h2>
	    	<p>
		...
		<div class="report-title-btn-sbj-btn">
    		...
    		<h3><?php echo _('Subject');?>: <?php echo get_saved_data('title');?> <a href="<?php echo get_app_info('path');?>/w/<?php echo encrypt_val($id);?>" title="<?php echo _('View the campaign');?>" class="iframe-preview"><span class="icon-eye-open"></span></a></h3>
		 </div>
    	...
    	<div class="row-fluid">
    		<div class="span4">
		    	<div class="shadow-hover">
					<div id="countries-container" style="min-height:300px;"></div>
				</div>
	    	</div>
    		<div class="span8">
			<div id="container" class="shadow-hover"></div>	
		    </div>
	    </div>
	    ...
	    <div class="row-fluid">
	    	<div class="span12">
	    		<h2><?php echo _('All countries');?></h2>
