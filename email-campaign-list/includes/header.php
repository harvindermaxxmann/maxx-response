...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="<?php echo get_app_info('path');?>/css/style.css" />
	      ...
	      <div class="navbar-inner">
	        <div class="container-fluid">
	          ...
	          <?php if(!get_app_info('is_sub_user') && CURRENT_DOMAIN == APP_PATH_DOMAIN):?>
		          ...
		          <a class="brand" href="<?php echo get_app_info('path');?>/"><img src="https://www.gravatar.com/avatar/<?php echo md5(strtolower(trim(get_app_info('email'))));?>?s=36&d=<?php echo get_app_info('path');?>/img/maxx-logo.png" title="" class="main-gravatar" onerror="this.src='<?php echo get_app_info('path');?>/img/maxx-logo.png'"/><?php echo get_app_info('company');?></a>
	          ...
	          <div class="btn-group brands-box">
