...
Vvveb.Components.extend("_base", "widgets/googlemaps", {
    ...
    image: uplevel+"icons/map.svg",
    dragHtml: '<img src="' + Vvveb.baseUrl + uplevel+'icons/maps.png">',
...
Vvveb.Components.extend("_base", "widgets/video", {
    ...
    dragHtml: '<img src="' + Vvveb.baseUrl + uplevel+'icons/video.svg" width="100" height="100">', //use image for drag and swap with iframe on drop for drag performance
...
Vvveb.Components.extend("_base", "widgets/facebookcomments", {
    ...
    image: uplevel+"icons/facebook.svg",
    dragHtml: '<img src="' + Vvveb.baseUrl + uplevel+'icons/facebook.svg">',
...
Vvveb.Components.extend("_base", "widgets/instagram", {
    ...
    image: uplevel+"icons/instagram.svg",
    drophtml: '<img src="' + Vvveb.baseUrl + uplevel+'icons/instagram.png">',
...
Vvveb.Components.extend("_base", "widgets/twitter", {
    ...
    image: uplevel+"icons/twitter.svg",
    dragHtml: '<img src="' + Vvveb.baseUrl + uplevel+'icons/twitter.svg">',
...
Vvveb.Components.extend("_base", "widgets/paypal", {
    ...
    image: uplevel+"icons/paypal.svg",
...
Vvveb.Components.extend("_base", "widgets/facebookpage", {
    ...
    image: uplevel+"icons/facebook.svg",
    dropHtml: '<img src="' + Vvveb.baseUrl + uplevel+'icons/facebook.png">',
...
Vvveb.Components.extend("_base", "widgets/chartjs", {
    ...
    image: uplevel+"icons/chart.svg",
	dragHtml: '<img src="' + Vvveb.baseUrl + uplevel+'icons/chart.svg">',
