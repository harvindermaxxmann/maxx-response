...
Vvveb.Components.extend("_base", "html/container", {
    ...
    image: uplevel+"icons/container.svg",
...
Vvveb.Components.extend("_base", "html/heading", {
    image: uplevel+"icons/heading.svg",
    name: "Heading",
...
Vvveb.Components.extend("_base", "html/image", {
    nodes: ["img"],
    name: "Image",
    html: '<img src="' +  Vvveb.baseUrl + + uplevel+ 'icons/image.svg" height="128" width="128">',
    /*
...
Vvveb.Components.extend("_base", "html/button", {
    ...
    name: "Button",
    image: uplevel+"icons/button.svg",
...
Vvveb.Components.extend("_base", "html/buttongroup", {
    classes: ["btn-group"],
    name: "Button Group",
    image: uplevel+"icons/button_group.svg",
...
Vvveb.Components.extend("_base", "html/buttontoolbar", {
    classes: ["btn-toolbar"],
    name: "Button Toolbar",
    image: uplevel+"icons/button_toolbar.svg",
...
Vvveb.Components.extend("_base", "html/listgroup", {
    name: "List Group",
    image: uplevel+"icons/list_group.svg",
    classes: ["list-group"],
...
Vvveb.Components.extend("_base", "html/breadcrumbs", {
    classes: ["breadcrumb"],
    name: "Breadcrumbs",
    image: uplevel+"icons/breadcrumbs.svg",
...
Vvveb.Components.extend("_base", "html/pagination", {
    classes: ["pagination"],
    name: "Pagination",
    image: uplevel+"icons/pagination.svg",
...
Vvveb.Components.extend("_base", "html/progress", {
    classes: ["progress"],
    name: "Progress Bar",
    image: uplevel+"icons/progressbar.svg",
...
Vvveb.Components.extend("_base", "html/jumbotron", {
    classes: ["jumbotron"],
    image: uplevel+"icons/jumbotron.svg",
    name: "Jumbotron",
...
Vvveb.Components.extend("_base", "html/navbar", {
    classes: ["navbar"],
    image: uplevel+"icons/navbar.svg",
    name: "Nav Bar",
...
Vvveb.Components.extend("_base", "html/textinput", {
    ...
    image: uplevel+"icons/text_input.svg",
...
Vvveb.Components.extend("_base", "html/selectinput", {
	nodes: ["select"],
    name: "Select Input",
    image: uplevel+"icons/select_input.svg",
...
Vvveb.Components.extend("_base", "html/textareainput", {
    name: "Text Area",
    image: uplevel+"icons/text_area.svg",
...
Vvveb.Components.extend("_base", "html/checkbox", {
    ...
    image: uplevel+"icons/checkbox.svg",
...
Vvveb.Components.add("html/gridcolumn", {
    name: "Grid Column",
    image: uplevel+"icons/grid_row.svg",
    classesRegex: ["col-"],
...
Vvveb.Components.extend("_base", "html/paragraph", {
    nodes: ["p"],
    name: "Paragraph",
	image: uplevel+"icons/paragraph.svg",
...
Vvveb.Components.extend("_base", "html/video", {
    ...
    dragHtml: '<img  width="320" height="240" src="' + Vvveb.baseUrl + uplevel+ 'icons/video.svg">',
	image: uplevel+"icons/video.svg",
    properties: [{
        name: "Src",
        child: "source",
        key: "src",
