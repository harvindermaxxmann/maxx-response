...
Vvveb.Components.add("components/products", {
    ...
    image: uplevel+"icons/products.svg",
...
Vvveb.Components.add("components/manufacturers", {
    ...
    image: uplevel+"icons/categories.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        nolabel:false,
        inputtype: TextInput,
...
Vvveb.Components.add("components/search", {
    ...
    image: uplevel+"icons/search.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/product_gallery", {
    ...
    image: uplevel+"icons/product_gallery.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/checkout", {
    ...
    image: uplevel+"icons/checkout.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/filters", {
    ...
    image: uplevel+"icons/filters.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/product", {
    ...
    image: uplevel+"icons/product.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
...
Vvveb.Components.add("components/slider", {
    ...
    image: uplevel+"icons/slider.svg",
    html: '<div class="form-group"><label>Your response:</label><textarea class="form-control"></textarea></div>',
    properties: [{
        name: "asdasdad",
        key: "src",
