...
<div class="row-fluid">
    ...
    <div class="span10">
	<div class="app-sec-box">
    	<div class="app-sec-head">
			<h2><?php echo _('All campaigns');?></h2>
	    	<p class="lead">
    	...
    	<div class="drp-dwn-sec-box">
			...
			<!-- Campaign RSS button -->
			<a href="#rss-modal" class="btn campaigns-rss-btn" style="" title="<?php echo _('Campaigns RSS feed');?>" data-toggle="modal"><i class="icon icon-rss"></i></a>
