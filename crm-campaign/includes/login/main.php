	...
	if ($r && mysqli_num_rows($r) > 0)
	{
		...
		{   // if we come from crm
			...
			// if(isset($_SESSION['status']) && !empty($_SESSION['status'])) {  
			 	// if (isset($_COOKIE['admin_email']) && !empty($_COOKIE['admin_email'])) {			

			// 	header("Location: https://maxxmanncommunications.com/crm-campaign/create?i=3");
			 //	header("location: https://maxxmanncommunications.com/crm-campaign/includes/templates/use-template.php?i=3&t=107");
			// 	//exit;
			//  }else{ 
				header("location: https://maxxmanncommunications.com/crm-campaign/create?i=3");
				// exit;
