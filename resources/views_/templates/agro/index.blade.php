...
<meta charset="utf-8">
	<!-- css files -->
    <link href="{{ asset('landing-assets/agro/css/bootstrap.css')}}" rel='stylesheet' type='text/css'><!-- bootstrap css -->
    <link href="{{ asset('landing-assets/agro/css/style.css')}}" rel='stylesheet' type='text/css'><!-- custom css -->
    <link href="{{ asset('landing-assets/agro/css/font-awesome.min.css')}}" rel="stylesheet"><!-- fontawesome css -->
	<!-- //css files -->	
	<link href="{{ asset('landing-assets/agro/css/css_slider.css')}}" type="text/css" rel="stylesheet" media="all">
	<!-- google fonts -->
...
<header>
	<div class="container">
		...
		<nav class="py-4 d-lg-flex">
			<div id="logo">
				<h1> <a href="#"><span class="fa fa-leaf"></span> Agro Harvest</a></h1>
			</div>		
		</nav>
		<!-- //nav -->
	</div>
	...
	<div class="container py-md-4">
		...
		<div class="row core-grids">
			<div class="col-lg-6 core-left">	
				<img src="{{ asset('landing-assets/agro/images/core.jpg')}}" class="img-fliud" alt="" />
			</div>
	...
	<div class="container py-md-5">
		...
		<div class="row blog-grids">
			<div class="col-lg-4 col-md-6 blog-left mb-lg-0 mb-sm-5 pb-lg-0 pb-5">	
				<img src="{{ asset('landing-assets/agro/images/s1.jpg')}}" class="img-fliud" alt="" />
				<div class="blog-info">
			...
			<div class="col-lg-4 col-md-6 blog-middle mb-lg-0 mb-sm-5 pb-lg-0 pb-md-5">	
				<img src="{{ asset('landing-assets/agro/images/s2.jpg')}}" class="img-fliud" alt="" />
				<div class="blog-info">
			...
			<div class="col-lg-4 col-md-6 blog-right mt-lg-0 mt-5 pt-lg-0 pt-md-5">
				<img src="{{ asset('landing-assets/agro/images/s3.jpg')}}" class="img-fliud" alt="" />
				<div class="blog-info">
	...
	<div class="container py-md-3 text-center">		
		<div class="row">
			<div class="col-12">
				...
				sunt dolor ipsum.</p>
				<a href="#" class="btn mr-3"> Our Services</a>
...
<footer class="text-center py-5">
	<div class="container py-md-3">
		...
		<div class="w3l-copy text-center">
			<p class="text-da">&copy; 2019 Agro Harvest. All rights reserved.</p>
		</div>
		<!-- //copyright -->
	</div>
</footer>
