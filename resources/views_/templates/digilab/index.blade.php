...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('landing-assets/digilab/css/open-iconic-bootstrap.min.css')}}">
    <link rel="stylesheet" href="{{ asset('landing-assets/digilab/css/animate.css')}}">
    
    <link rel="stylesheet" href="{{ asset('landing-assets/digilab/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{ asset('landing-assets/digilab/css/owl.theme.default.min.css')}}">
    <link rel="stylesheet" href="{{ asset('landing-assets/digilab/css/magnific-popup.css')}}">

    <link rel="stylesheet" href="{{ asset('landing-assets/digilab/css/aos.css')}}">

    <link rel="stylesheet" href="{{ asset('landing-assets/digilab/css/ionicons.min.css')}}">
    
    <link rel="stylesheet" href="{{ asset('landing-assets/digilab/css/flaticon.css')}}">
    <link rel="stylesheet" href="{{ asset('landing-assets/digilab/css/icomoon.css')}}">
    <link rel="stylesheet" href="{{ asset('landing-assets/digilab/css/style.css')}}">
  </head>
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-md-flex no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
	          	<div class="one-third order-md-last img js-fullheight" style="background-image:url('/landing-assets/digilab/images/bg_1.jpg');">
	          		<div class="overlay"></div>
	          	</div>
	      ...
	      <div class="slider-item js-fullheight">
	        ...
	        <div class="container-fluid p-0">
	          <div class="row d-flex no-gutters slider-text js-fullheight align-items-center justify-content-end" data-scrollax-parent="true">
	          	<div class="one-third order-md-last img js-fullheight" style="background-image:url('/landing-assets/digilab/images/bg_2.jpg');">
	          		<div class="overlay"></div>
	          	</div>
		          <div class="one-forth d-flex js-fullheight align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
    ...
    <section class="ftco-section-2 img" style="background-image: url('/landing-assets/digilab/images/bg_3.jpg');">
    	<div class="container">
          ...
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <div class="carousel-project owl-carousel">
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="{{ asset('landing-assets/digilab/images/project-1.jpg')}}" class="img-fluid" alt="Colorlib Template">
				    				<div class="text px-4">
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="{{ asset('landing-assets/digilab/images/project-2.jpg')}}" class="img-fluid" alt="Colorlib Template">
				    				<div class="text px-4">
				    					<h3><a href="#">Work Name</a></h3>
				    					<span>Web Design</span>
				    				</div>
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="{{ asset('landing-assets/digilab/images/project-3.jpg')}}" class="img-fluid" alt="Colorlib Template">
				    				<div class="text px-4">
				    					<h3><a href="#">Work Name</a></h3>
				    					<span>Web Design</span>
				    				</div>
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="{{ asset('landing-assets/digilab/images/project-4.jpg')}}" class="img-fluid" alt="Colorlib Template">
				    				<div class="text px-4">
				    					<h3><a href="#">Work Name</a></h3>
				    					<span>Web Design</span>
				    				</div>
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="{{ asset('landing-assets/digilab/images/project-5.jpg')}}" class="img-fluid" alt="Colorlib Template">
				    				<div class="text px-4">
				    					<h3><a href="#">Work Name</a></h3>
				    					<span>Web Design</span>
				    				</div>
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="{{ asset('landing-assets/digilab/images/project-6.jpg')}}" class="img-fluid" alt="Colorlib Template">
				    				<div class="text px-4">
				    					<h3><a href="#">Work Name</a></h3>
				    					<span>Web Design</span>
				    				</div>
    	...
    	<div class="container">
    		<div class="row d-flex">
    			<div class="col-md-6 col-lg-5 d-flex">
    				<div class="img d-flex align-self-stretch align-items-center" style="background-image: url('/landing-assets/digilab/images/about.jpg');">
    				</div>
    			</div>
    ...
    <section class="ftco-section">
        ...
        <div class="row">
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url('/landing-assets/digilab/images/staff-1.jpg');"></div>
							</div>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url('/landing-assets/digilab/images/staff-2.jpg');"></div>
							</div>
							<div class="text d-flex align-items-center pt-3 text-center">
								<div>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url('/landing-assets/digilab/images/staff-3.jpg');"></div>
							</div>
							<div class="text d-flex align-items-center pt-3 text-center">
								<div>
					...
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="staff">
							<div class="img-wrap d-flex align-items-stretch">
								<div class="img align-self-stretch" style="background-image: url('/landing-assets/digilab/images/staff-4.jpg');"></div>
							</div>
							<div class="text d-flex align-items-center pt-3 text-center">
								<div>
            ...
            <div class="carousel-testimony owl-carousel ftco-owl">
              <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div class="user-img" style="background-image: url('/landing-assets/digilab/images/person_1.jpg');">
              ...
              <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div class="user-img" style="background-image: url('/landing-assets/digilab/images/person_2.jpg');">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div class="user-img" style="background-image: url('/landing-assets/digilab/images/person_3.jpg');">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap text-center py-4 pb-5">
                  <div class="user-img" style="background-image: url('/landing-assets/digilab/images/person_4.jpg');">
                    <span class="quote d-flex align-items-center justify-content-center">
                      <i class="icon-quote-left"></i>
                    </span>
                  </div>
      ...
      <div class="container">
        ...
        <div class="row d-flex">
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="single.html" class="block-20" style="background-image: url('/landing-assets/digilab/images/image_1.jpg');">
              </a>
          ...
          <div class="col-md-4 d-flex ftco-animate">
          	<div class="blog-entry justify-content-end">
              <a href="single.html" class="block-20" style="background-image: url('/landing-assets/digilab/images/image_2.jpg');">
              </a>
              <div class="text mt-3 float-right d-block">
              	<div class="d-flex align-items-center pt-2 mb-4 topp">
              		<div class="one mr-2">
          ...
          <div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="single.html" class="block-20" style="background-image: url('/landing-assets/digilab/images/image_3.jpg');">
              </a>
              <div class="text mt-3 float-right d-block">
              	<div class="d-flex align-items-center pt-2 mb-4 topp">
              		<div class="one mr-2">
  ...
  <script src="{{ asset('landing-assets/digilab/js/jquery.min.js')}}"></script>
  <script src="{{ asset('landing-assets/digilab/js/jquery-migrate-3.0.1.min.js')}}"></script>
  <script src="{{ asset('landing-assets/digilab/js/popper.min.js')}}"></script>
  <script src="{{ asset('landing-assets/digilab/js/bootstrap.min.js')}}"></script>
  <script src="{{ asset('landing-assets/digilab/js/jquery.easing.1.3.js')}}"></script>
  <script src="{{ asset('landing-assets/digilab/js/jquery.waypoints.min.js')}}"></script>
  <script src="{{ asset('landing-assets/digilab/js/jquery.stellar.min.js')}}"></script>
  <script src="{{ asset('landing-assets/digilab/js/owl.carousel.min.js')}}"></script>
  <script src="{{ asset('landing-assets/digilab/js/jquery.magnific-popup.min.js')}}"></script>
  <script src="{{ asset('landing-assets/digilab/js/aos.js')}}"></script>
  <script src="{{ asset('landing-assets/digilab/js/jquery.animateNumber.min.js')}}"></script>
  <script src="{{ asset('landing-assets/digilab/js/scrollax.min.js')}}"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="{{ asset('landing-assets/digilab/js/google-map.js')}}"></script>
  
  <script src="{{ asset('landing-assets/digilab/js/main.js')}}"></script>
