...
<head>
    ...
    <!-- Core Stylesheet -->
    <link href="{{ asset('landing-assets/cacolorlib/style.css')}}" rel="stylesheet">

    <!-- Responsive CSS -->
    <link href="{{ asset('landing-assets/cacolorlib/css/responsive.css')}}" rel="stylesheet">
...
<body>
    ...
    <section class="wellcome_area clearfix" id="home">
                ...
                <div class="col-12 col-md">
                    ...
                    <div class="get-start-area">
                        ...
                        <form action="#" method="post" class="form-inline">
                            <input type="email" class="form-control email" placeholder="name@company.com" required="required">
        ...
        <div class="welcome-thumb wow fadeInDown" data-wow-delay="0.5s">
            <img src="{{ asset('landing-assets/cacolorlib/img/bg-img/welcome-img.png')}}" alt="">
        </div>
    </section>
    <!-- ***** Wellcome Area End ***** -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="special_description_img">
                            <img src="{{ asset('landing-assets/cacolorlib/img/bg-img/special.png')}}" alt="">
                        </div>
                    </div>
    ...
    <div class="video-section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <!-- Video Area Start -->
                    <div class="video-area" style="background-image: url('/landing-assets/cacolorlib/img/bg-img/video.jpg');">
                ...
                <div class="col-12">
                    ...
                    <div class="app_screenshots_slides owl-carousel">
                        <div class="single-shot">
                            <img src="{{ asset('landing-assets/cacolorlib/img/scr-img/app-1.jpg')}}" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="{{ asset('landing-assets/cacolorlib/img/scr-img/app-2.jpg')}}" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="{{ asset('landing-assets/cacolorlib/img/scr-img/app-3.jpg')}}" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="{{ asset('landing-assets/cacolorlib/img/scr-img/app-4.jpg')}}" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="{{ asset('landing-assets/cacolorlib/img/scr-img/app-5.jpg')}}" alt="">
                        </div>
                        <div class="single-shot">
                            <img src="{{ asset('landing-assets/cacolorlib/img/scr-img/app-3.jpg')}}" alt="">
                        </div>
                ...
                <div class="col-12 col-md-6 col-lg-5">
                    <div class="slider slider-nav">
                        <div class="client-thumbnail">
                            <img src="{{ asset('landing-assets/cacolorlib/img/bg-img/client-3.jpg')}}" alt="">
                        </div>
                        <div class="client-thumbnail">
                            <img src="{{ asset('landing-assets/cacolorlib/img/bg-img/client-2.jpg')}}" alt="">
                        </div>
                        <div class="client-thumbnail">
                            <img src="{{ asset('landing-assets/cacolorlib/img/bg-img/client-1.jpg')}}" alt="">
                        </div>
                        <div class="client-thumbnail">
                            <img src="{{ asset('landing-assets/cacolorlib/img/bg-img/client-2.jpg')}}" alt="">
                        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="{{ asset('landing-assets/cacolorlib/img/team-img/team-1.jpg')}}" alt="">
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="{{ asset('landing-assets/cacolorlib/img/team-img/team-2.jpg')}}" alt="">
                            <div class="team-hover-effects">
                                <div class="team-social-icon">
                                    <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="{{ asset('landing-assets/cacolorlib/img/team-img/team-3.jpg')}}" alt="">
                            <div class="team-hover-effects">
                                <div class="team-social-icon">
                                    <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                ...
                <div class="col-12 col-md-6 col-lg-3">
                    <div class="single-team-member">
                        <div class="member-image">
                            <img src="{{ asset('landing-assets/cacolorlib/img/team-img/team-4.jpg')}}" alt="">
                            <div class="team-hover-effects">
                                <div class="team-social-icon">
                                    <a href="#"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                    <a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a>
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="email-text">
                        <p><span>Email:</span> info@websiteurl.com</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <!-- Form Start-->
    ...
    <!-- ***** Footer Area Start ***** -->
    <footer class="footer-social-icon text-center section_padding_70_0 clearfix">
    ...
    <!-- Jquery-2.2.4 JS -->
    <script src="{{ asset('landing-assets/cacolorlib/js/jquery-2.2.4.min.js')}}"></script>
    <!-- Popper js -->
    <script src="{{ asset('landing-assets/cacolorlib/js/popper.min.js')}}"></script>
    <!-- Bootstrap-4 Beta JS -->
    <script src="{{ asset('landing-assets/cacolorlib/js/bootstrap.min.js')}}"></script>
    <!-- All Plugins JS -->
    <script src="{{ asset('landing-assets/cacolorlib/js/plugins.js')}}"></script>
    <!-- Slick Slider Js-->
    <script src="{{ asset('landing-assets/cacolorlib/js/slick.min.js')}}"></script>
    <!-- Footer Reveal JS -->
    <script src="{{ asset('landing-assets/cacolorlib/js/footer-reveal.min.js')}}"></script>
    <!-- Active JS -->
    <script src="{{ asset('landing-assets/cacolorlib/js/active.js')}}"></script>
</body>
