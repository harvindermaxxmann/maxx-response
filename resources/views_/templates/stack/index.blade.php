...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="{{ asset('landing-assets/stack/assets/css/bootstrap.min.css')}}" >
    <!-- Icon -->
    <link rel="stylesheet" href="{{ asset('landing-assets/stack/assets/fonts/line-icons.css')}}">
    <!-- Slicknav -->
    <link rel="stylesheet" href="{{ asset('landing-assets/stack/assets/css/slicknav.css')}}">
    <!-- Owl carousel -->
    <link rel="stylesheet" href="{{ asset('landing-assets/stack/assets/css/owl.carousel.min.css')}}">
    <link rel="stylesheet" href="{{ asset('landing-assets/stack/assets/css/owl.theme.css')}}">
    
    <link rel="stylesheet" href="{{ asset('landing-assets/stack/assets/css/magnific-popup.css')}}">
    <link rel="stylesheet" href="{{ asset('landing-assets/stack/assets/css/nivo-lightbox.css')}}">
    <!-- Animate -->
    <link rel="stylesheet" href="{{ asset('landing-assets/stack/assets/css/animate.css')}}">
    <!-- Main Style -->
    <link rel="stylesheet" href="{{ asset('landing-assets/stack/assets/css/main.css')}}">
    <!-- Responsive Style -->
    <link rel="stylesheet" href="{{ asset('landing-assets/stack/assets/css/responsive.css')}}">
  ...
  <body>
    ...
    <header id="header-wrap">
      ...
      <nav class="navbar navbar-expand-md bg-inverse fixed-top scrolling-navbar">
        <div class="container">
          ...
          <a href="index.html" class="navbar-brand"><img src="{{ asset('landing-assets/stack/assets/img/logo.png')}}" alt=""></a>       
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12">
              ...
              <div class="img-thumb text-center wow fadeInUp" data-wow-delay="0.6s">
                <img class="img-fluid" src="{{ asset('landing-assets/stack/assets/img/hero-1.png')}}" alt="">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-sm-6 col-md-6 col-lg-3">
            ...
            <div class="team-item text-center wow fadeInRight" data-wow-delay="0.3s">
              <div class="team-img">
                <img class="img-fluid" src="{{ asset('landing-assets/stack/assets/img/team/team-01.png')}}" alt="">
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            ...
            <div class="team-item text-center wow fadeInRight" data-wow-delay="0.6s">
              <div class="team-img">
                <img class="img-fluid" src="{{ asset('landing-assets/stack/assets/img/team/team-02.png')}}" alt="">
                <div class="team-overlay">
                  <div class="overlay-social-icon text-center">
                    <ul class="social-icons">
                      <li><a href="#"><i class="lni-facebook-filled" aria-hidden="true"></i></a></li>
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            ...
            <div class="team-item text-center wow fadeInRight" data-wow-delay="0.9s">
              <div class="team-img">
                <img class="img-fluid" src="{{ asset('landing-assets/stack/assets/img/team/team-03.png')}}" alt="">
                <div class="team-overlay">
                  <div class="overlay-social-icon text-center">
                    <ul class="social-icons">
                      <li><a href="#"><i class="lni-facebook-filled" aria-hidden="true"></i></a></li>
          ...
          <div class="col-sm-6 col-md-6 col-lg-3">
            ...
            <div class="team-item text-center wow fadeInRight" data-wow-delay="1.2s">
              <div class="team-img">
                <img class="img-fluid" src="{{ asset('landing-assets/stack/assets/img/team/team-04.png')}}" alt="">
                <div class="team-overlay">
                  <div class="overlay-social-icon text-center">
                    <ul class="social-icons">
                      <li><a href="#"><i class="lni-facebook-filled" aria-hidden="true"></i></a></li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 col-md-12 col-xs-12 wow fadeInLeft" data-wow-delay="0.3s">
            <img class="img-fluid" src="{{ asset('landing-assets/stack/assets/img/about/img-1.jpg')}}" alt="" >
          </div>
        ...
        <div id="portfolio" class="row">
          <div class="col-lg-4 col-md-6 col-xs-12 mix development print">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="{{ asset('landing-assets/stack/assets/img/portfolio/img-1.jpg')}}" alt="" />  
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="{{ asset('landing-assets/stack/assets/img/portfolio/img-1.jpg')}}"><i class="lni-eye item-icon"></i></a>
                      </div>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 mix design print">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="{{ asset('landing-assets/stack/assets/img/portfolio/img-2.jpg')}}" alt="" /> 
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="{{ asset('landing-assets/stack/assets/img/portfolio/img-2.jpg')}}"><i class="lni-eye item-icon"></i></a>
                      </div>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 mix development">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="{{ asset('landing-assets/stack/assets/img/portfolio/img-3.jpg')}}" alt="" />  
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="{{ asset('landing-assets/stack/assets/img/portfolio/img-3.jpg')}}"><i class="lni-eye item-icon"></i></a>
                      </div>
                      <a href="#">Responsive</a>
                    </div>
                  </div>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 mix development design">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="{{ asset('landing-assets/stack/assets/img/portfolio/img-4.jpg')}}" alt="" /> 
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="{{ asset('landing-assets/stack/assets/img/portfolio/img-4.jpg')}}"><i class="lni-eye item-icon"></i></a>
                      </div>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 mix development">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="{{ asset('landing-assets/stack/assets/img/portfolio/img-5.jpg')}}" alt="" />  
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="{{ asset('landing-assets/stack/assets/img/portfolio/img-5.jpg')}}"><i class="lni-eye item-icon"></i></a>
                      </div>
          ...
          <div class="col-lg-4 col-md-6 col-xs-12 mix print design">
            <div class="portfolio-item">
              <div class="shot-item">
                <img src="{{ asset('landing-assets/stack/assets/img/portfolio/img-6.jpg')}}" alt="" />  
                <div class="single-content">
                  <div class="fancy-table">
                    <div class="table-cell">
                      <div class="zoom-icon">
                        <a class="lightbox" href="{{ asset('landing-assets/stack/assets/img/portfolio/img-6.jpg')}}"><i class="lni-eye item-icon"></i></a>
                      </div>
            ...
            <div id="testimonials" class="owl-carousel wow fadeInUp" data-wow-delay="1.2s">
              <div class="item">
                <div class="testimonial-item">
                  <div class="img-thumb">
                    <img src="{{ asset('landing-assets/stack/assets/img/testimonial/img1.jpg')}}" alt="">
                  </div>
                  <div class="info">
              ...
              <div class="item">
                <div class="testimonial-item">
                  <div class="img-thumb">
                    <img src="{{ asset('landing-assets/stack/assets/img/testimonial/img2.jpg')}}" alt="">
                  </div>
                  <div class="info">
              ...
              <div class="item">
                <div class="testimonial-item">
                  <div class="img-thumb">
                    <img src="{{ asset('landing-assets/stack/assets/img/testimonial/img3.jpg')}}" alt="">
                  </div>
                  <div class="info">
              ...
              <div class="item">
                <div class="testimonial-item">
                  <div class="img-thumb">
                    <img src="{{ asset('landing-assets/stack/assets/img/testimonial/img4.png')}}" alt="">
                  </div>
                  <div class="info">
              ...
              <div class="item">
                <div class="testimonial-item">
                  <div class="img-thumb">
                    <img src="{{ asset('landing-assets/stack/assets/img/testimonial/img5.png')}}" alt="">
                  </div>
                  <div class="info">
        ...
        <div class="row">
            ...
            <div class="blog-item-wrapper wow fadeInLeft" data-wow-delay="0.3s">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="{{ asset('landing-assets/stack/assets/img/blog/img1.jpg')}}" alt="">
                </a>                
              </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper wow fadeInUp" data-wow-delay="0.6s">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="{{ asset('landing-assets/stack/assets/img/blog/img2.jpg')}}" alt="">
                </a>                
              </div>
              <div class="blog-item-text"> 
                <h3>
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12 blog-item">
            ...
            <div class="blog-item-wrapper wow fadeInRight" data-wow-delay="0.3s">
              <div class="blog-item-img">
                <a href="single-post.html">
                  <img src="{{ asset('landing-assets/stack/assets/img/blog/img3.jpg')}}" alt="">
                </a>                
              </div>
              <div class="blog-item-text"> 
                <h3>
        ...
        <div class="row text-align-">
          <div class="col-lg-3 col-md-3 col-xs-12 wow fadeInUp" data-wow-delay="0.3s">
            <div class="client-item-wrapper">
              <img class="img-fluid" src="{{ asset('landing-assets/stack/assets/img/clients/img1.png')}}" alt="">
            </div>
          </div>
          <div class="col-lg-3 col-md-3 col-xs-12 wow fadeInUp" data-wow-delay="0.6s">
            <div class="client-item-wrapper">
              <img class="img-fluid" src="{{ asset('landing-assets/stack/assets/img/clients/img2.png')}}" alt="">
            </div>
          </div>
          <div class="col-lg-3 col-md-3 col-xs-12 wow fadeInUp" data-wow-delay="0.9s">
            <div class="client-item-wrapper">
              <img class="img-fluid" src="{{ asset('landing-assets/stack/assets/img/clients/img3.png')}}" alt="">
            </div>
          </div>
          <div class="col-lg-3 col-md-3 col-xs-12 wow fadeInUp" data-wow-delay="1.2s">
            <div class="client-item-wrapper">
              <img class="img-fluid"  src="{{ asset('landing-assets/stack/assets/img/clients/img4.png')}}" alt="">
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-3 col-xs-12">
            <div class="footer-logo">
              <img src="{{ asset('landing-assets/stack/assets/img/logo.png')}}" alt="">
            </div>
          </div>
    ...
    <script src="{{ asset('landing-assets/stack/assets/js/jquery-min.js')}}"></script>
    <script src="{{ asset('landing-assets/stack/assets/js/popper.min.js')}}"></script>
    <script src="{{ asset('landing-assets/stack/assets/js/bootstrap.min.js')}}"></script>
    <script src="{{ asset('landing-assets/stack/assets/js/owl.carousel.min.js')}}"></script>
    <script src="{{ asset('landing-assets/stack/assets/js/jquery.mixitup.js')}}"></script>
    <script src="{{ asset('landing-assets/stack/assets/js/wow.js')}}"></script>
    <script src="{{ asset('landing-assets/stack/assets/js/jquery.nav.js')}}"></script>
    <script src="{{ asset('landing-assets/stack/assets/js/scrolling-nav.js')}}"></script>
    <script src="{{ asset('landing-assets/stack/assets/js/jquery.easing.min.js')}}"></script>
    <script src="{{ asset('landing-assets/stack/assets/js/jquery.counterup.min.js')}}"></script>  
    <script src="{{ asset('landing-assets/stack/assets/js/nivo-lightbox.js')}}"></script>     
    <script src="{{ asset('landing-assets/stack/assets/js/jquery.magnific-popup.min.js')}}"></script>     
    <script src="{{ asset('landing-assets/stack/assets/js/waypoints.min.js')}}"></script>   
    <script src="{{ asset('landing-assets/stack/assets/js/jquery.slicknav.js')}}"></script>
    <script src="{{ asset('landing-assets/stack/assets/js/main.js')}}"></script>
    <script src="{{ asset('landing-assets/stack/assets/js/form-validator.min.js')}}"></script>
    <script src="{{ asset('landing-assets/stack/assets/js/contact-form-script.min.js')}}"></script>
