...
<div id="contents">
    ...
    <div class="container-fluid">
    	<div class="planline page-title pad_top10 text-center">
            <span>Create Facebook Ads Campaign</span>
        </div>
        ...
        <div class="ads-campaign">
                <form action="">
                    ...
                    <div class="connect">
                        <h5>Facebook Page</h5>
                        <p>We need your company's Facebook page information so you can reach potential customers on Facebook. Your ads will appear in the Newsfeed and link to your website.</p>
                        <p>
                            <button type="button" class="btn btn-primary"><i class="fa fa-facebook-official" aria-hidden="true"></i> Log in with Facebook</button>
                        </p>

                        <h5 class="pad_top15">Instagram Account</h5>
                        <p>Your ads will use your Instagram page name and profile picture and will link to your company's site by default.</p>
                        <p>
                            <button type="button" class="btn btn-primary" disabled=""><i class="fa fa-instagram" aria-hidden="true"></i> Connect Instagram Account</button>
                        </p>

                        <p>Don't have Admin access to your Facebook page? <a href="#">Send an access request.</a></p>
                    </div>
