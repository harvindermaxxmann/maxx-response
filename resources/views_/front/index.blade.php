...
@section('content')
<!-- Hero Header -->
<header class="hero-header pad_top4">
...
<section class="page-section padlowtopbot" id="intro">
                ...
                <div class="col-xs-12 col-sm-12 p-0 text-center">
                    ...
                    <p>
                        <a href="{{url('/pricing')}}" class="btn btn-darkgrey mar_top20 btn-lg text-uppercase" style="font-weight: 600;">View Pricing</a>
                         @if(!Auth::check())
                        <a href="{{action('IndexController@register')}}" class="btn btn-orange mar_top20 mar_left15 btn-lg text-uppercase" style="font-weight: 600;">Register Free</a>
                        @endif
                    </p>
                </div>
    ...
    <section id="services">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-md-4">
                        ...
                        <p>First impressions are lasting impressions. Landing pages give a glimpse to your business and  what your brand is about. Whatever your current business goals may be, increasing sales figures growing your customer base or stepping into a new market,  a well-crafted landing pages support all these objectives.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">                
                    <div class="col-xs-12 col-md-5">
                        <h3 style="padding-top: 37px;">Be everywhere your customers are</h3>
                    ...
                    <div class="col-xs-12 col-md-7 text-right hidden-xs">
                        <img src="{{ asset('images/campaign-section-img2.png')}}" alt="" class="img-responsive">                 
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="service_grid grey">
            <div class="container">
                <div class="text-center pb-10"><img src="{{ asset('images/tools-icon.png')}}" alt=""></div>      
                <h3 class="text-center">All the tools you need...</h3>
                <p class="text-center pb-25">and maybe a few you didn't know you needed</p>
                
                <div class="row bifurcations_list pb-50">
                    <div class="col-xs-12 col-md-5">
                        <h4 class="text-right">Be everywhere your <br> customers are.</h4>
                    </div>
                    <div class="col-xs-12 col-md-7">
                        <div class="row">
                            <div class="col-xs-12 col-md-6">
                                <h5><img src="{{ asset('images/mail-icon.png')}}" alt=""> Email Marketing</h5>
                                <p>Get the word out and sell more with sleek email messages that you can design in no time</p>
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <h5><img src="{{ asset('images/sms-icon2.png')}}" alt=""> SMS Marketing</h5>
                 ...
                 <div class="row bifurcations_list">
                    <div class="col-xs-12 col-md-5">
                        <h4 class="text-right">Turn your visitors <br> into customers.</h4>
                    </div>
                    <div class="col-xs-12 col-md-7">
                        <div class="row pb-25">
                            <div class="col-xs-12 col-md-6">
                                <h5><img src="{{ asset('images/newsletter-icon2.png')}}" alt=""> Newsletter</h5>
                                <p>Get the word out and sell more with sleek email messages that you can design in no time</p>
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <h5><img src="{{ asset('images/landing-page-icon.png')}}" alt="">  Landing Pages</h5>
                                <p>Get the word out and sell more with sleek email messages that you can design in no time</p>
                            </div>
                        </div>
                        ...
                        <div class="row pb-25">
                            <div class="col-xs-12 col-md-6">
                                <h5><img src="{{ asset('images/survey-icon.png')}}" alt=""> Surveys</h5>
                                <p>Get the word out and sell more with sleek email messages that you can design in no time</p>
                            </div>
                            <div class="col-xs-12 col-md-6">
                                <h5><img src="{{ asset('images/poll-icon.png')}}" alt=""> Polls</h5>
                                <p>Get the word out and sell more with sleek email messages that you can design in no time</p>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-md-6">
                                <h5><img src="{{ asset('images/invitation-icon.png')}}" alt=""> Invitations</h5>
                                <p>Get the word out and sell more with sleek email messages that you can design in no time</p>
                            </div>
                        </div>
