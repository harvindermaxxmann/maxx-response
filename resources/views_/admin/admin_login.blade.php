...
<div class="content">
	...
	@endif
	<form id="admin-login-form" class="login-form" action="{{ action('AdminController@login')}}" method="post">
		@include('common.errors')
		<input type="hidden" name="_token" value="{{ csrf_token() }}">
		<h3 class="form-title">MaxxResponse Admin Login</h3>
		<div class="form-group">
			<label class="control-label visible-ie8 visible-ie9">Username</label>
			<div class="input-icon">
				<i class="fa fa-user"></i>
				<input class="form-control placeholder-no-fix" type="text" <?php if(isset($stayTuned['username'])){ ?> value="<?php echo  $stayTuned['username'] ?>" <?php } ?> placeholder="Username" name="username"/>
			</div>
		</div>
		<div class="form-group">
...
<div class="copyright">
	 <?php echo date('Y'); ?> &copy; MaxxMann Communications Admin
</div>
@endsection
