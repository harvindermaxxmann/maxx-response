...
<head>
   ...
   ================================================== -->
    ...
    <!-- CSS
   ================================================== -->
    <link rel="stylesheet" href="{{ asset('landing-assets/dazzle/css/base.css')}}">
    <link rel="stylesheet" href="{{ asset('landing-assets/dazzle/css/vendor.css')}}">
    <link rel="stylesheet" href="{{ asset('landing-assets/dazzle/css/main.css')}}">

    <!-- script
   ================================================== -->
    <script src="{{ asset('landing-assets/dazzle/js/modernizr.js')}}"></script>
    <script src="{{ asset('landing-assets/dazzle/js/pace.min.js')}}"></script>
...
<body id="top">
   ...
   <header id="header" class="row">   
   		...
   		<div class="header-logo">
	        <a href="Landing_Page1.html">MDevelopment</a>
	    </div>
...
<a href="#" title="sign-up" class="button button-primary cta sign_button">Sign Up</a>
		<!--a class="header-menu-toggle" href="javascript:;"><span>Menu</span></a-->    	
   ...
   <!-- home
   ================================================== -->
   <section id="home" data-parallax="scroll" data-image-src="{{ asset('landing-assets/dazzle/images/hero-bg.jpg')}}" data-natural-width="3000" data-natural-height="2000">
        ...
        <div class="home-content">        
            ...
            <div class="row contents">                     
                ...
                <div class="home-image-right">
                    <img src="{{ asset('landing-assets/dazzle/images/iphone-app-470.png')}}" srcset="{{ asset('landing-assets/dazzle/images/iphone-app-470.png')}} 1x, {{ asset('landing-assets/dazzle/images/iphone-app-940.png')}} 2x" data-aos="fade-up" alt="iphone image">
                </div>
            </div>
    ...
    <section id="about">
        ...
        <div class="row about-bottom-image">
           ...
           <img src="{{ asset('landing-assets/dazzle/images/app-screens-1200.png')}}" 
                srcset="{{ asset('landing-assets/dazzle/images/app-screens-600.png')}} 600w, 
                        {{ asset('landing-assets/dazzle/images/app-screens-1200.png')}} 1200w, 
                        {{ asset('landing-assets/dazzle/images/app-screens-2800.png')}} 2800w" 
                ...
                <div class="slides owl-carousel">
                    ...
                    <div>
                        ...
                        <div class="testimonial-author">
                                <img src="{{ asset('landing-assets/dazzle/images/avatars/user-02.jpg')}}" alt="Author image">
                    ...
                    <div>
                        ...
                        <div class="testimonial-author">
                                <img src="{{ asset('landing-assets/dazzle/images/avatars/user-03.jpg')}}" alt="Author image">
                                <div class="author-info">
                                    John Doe
    ...
    <!-- Java Script
    ================================================== -->
    <script src="{{ asset('landing-assets/dazzle/js/jquery-2.1.3.min.js')}}"></script>
    <script src="{{ asset('landing-assets/dazzle/js/plugins.js')}}"></script>
    <script src="{{ asset('landing-assets/dazzle/js/main.js')}}"></script>
