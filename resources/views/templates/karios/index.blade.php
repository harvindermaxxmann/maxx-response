...
<head>
    ...
    <!-- CSS
    ================================================== -->
    <link rel="stylesheet" href="{{ asset('landing-assets/karios/css/base.css')}}">
    <link rel="stylesheet" href="{{ asset('landing-assets/karios/css/vendor.css')}}">
    <link rel="stylesheet" href="{{ asset('landing-assets/karios/css/main.css')}}">

    <!-- script
    ================================================== -->
    <script src="{{asset('landing-assets/karios/js/modernizr.js')}}"></script>
    <script src="{{asset('landing-assets/karios/js/pace.min.js')}}"></script>
...
<body id="top">
        ...
        <div class="row">
            <div class="header-logo">
                <a class="site-logo" href="index.html">
                    <img src="{{asset('landing-assets/karios/images/logo.svg')}}" alt="Homepage">
                </a>
            </div>
    ...
    <!-- home
    ================================================== -->
    <section id="home" class="s-home target-section" data-parallax="scroll" data-image-src="{{asset('landing-assets/karios/images/hero-bg.jpg')}}" data-natural-width=3000 data-natural-height=2000 data-position-y=center>
        ...
        <div class="home-content">
            ...
            <div class="row home-content__main">
                ...
                <div class="home-content__right">
                    <img src="{{asset('landing-assets/karios/images/hero-app-screens-800.png')}}" srcset="{{asset('landing-assets/karios/images/hero-app-screens-800.png')}} 1x, {{asset('landing-assets/karios/images/hero-app-screens-1600.png')}} 2x">
            ...
            <div class="row testimonials">
                ...
                <div class="col-full slick-slider testimonials__slider">
                    ...
                    <div class="testimonials__slide">
                        <img src="{{asset('landing-assets/karios/images/avatars/user-03.jpg')}}" alt="Author image" class="testimonials__avatar">
                    ...
                    <div class="testimonials__slide">
                        <img src="{{asset('landing-assets/karios/images/avatars/user-05.jpg')}}" alt="Author image" class="testimonials__avatar">
                    ...
                    <div class="testimonials__slide">
                        <img src="{{asset('landing-assets/karios/images/avatars/user-01.jpg')}}" alt="Author image" class="testimonials__avatar">
    ...
    <section id="download" class="s-download target-section">
        ...
        <div class="row download-bottom-image" data-aos="fade-up">
            <img src="{{asset('landing-assets/karios/images/app-screen-1400.png')}}" 
                srcset="{{asset('landing-assets/karios/images/app-screen-600.png')}} 600w, 
                        {{asset('landing-assets/karios/images/app-screen-1400.png')}} 1400w, 
                        {{asset('landing-assets/karios/images/app-screen-2800.png')}} 2800w" 
    ...
    <!-- Java Script
    ================================================== -->
    <script src="{{asset('landing-assets/karios/js/jquery-3.2.1.min.js')}}"></script>
    <script src="{{asset('landing-assets/karios/js/plugins.js')}}"></script>
    <script src="{{asset('landing-assets/karios/js/main.js')}}"></script>
