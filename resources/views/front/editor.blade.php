...
<html lang="en">
    <head>
        ...
        <base href="">
        <title>Drag and Drop Editor - Maxx Response</title>
        <link href="{{ asset('editor/css/editor.css')}}" rel="stylesheet">
        <link href="{{ asset('editor/css/line-awesome.css')}}" rel="stylesheet">
    </head>
    <body>
        <style type="text/css">
        #Loader {background: #ffffff;color: #666666;position: fixed;height: 100%;width: 100%;z-index: 5000;top: 0;left: 0;float: left;text-align: center;padding-top: 25%;opacity: .80;}
        .spinner {margin: 0 auto;height: 64px;width: 64px;animation: rotate 0.8s infinite linear;border: 5px solid #A9A9A9;border-right-color: transparent;border-radius: 50%;}
        ...
        <div id="Loader">
            ...
            <br/>
            <p style="color: #000000;">Please Wait...</p>
        </div>
        <div id="vvveb-builder">
            <span id="ref" style="display: none;">{{$_GET['ref']}}</span>
            <span id="draftype" style="display: none;">{{$_GET['type']}}</span>
            <div id="top-panel">
                ...
                <div class="btn-group float-left" role="group">
                    ...
                    <img src="{{ asset('editor/libs/builder/icons/file-manager-layout.svg')}}" width="20px" height="20px">
                    </button> -->
                    ...
                    <img src="{{ asset('editor/libs/builder/icons/left-column-layout.svg')}}" width="20px" height="20px">
                    </button>
                    ...
                    <img src="{{ asset('editor/libs/builder/icons/right-column-layout.svg')}}" width="20px" height="20px">
                    </button>
                ...
                <div class="btn-group mr-3" role="group">
                    @if($_GET['type']=="landing-page")
                        <button class="btn btn-light" title="Save & Next" id="save-btn" data-vvveb-action="saveAjax" data-actiontype="{{$_GET['a']}}#save-next">
                    Save &amp; Next
                    </button>
                    @else
                        <button class="btn btn-light" title="Save & Next" id="save-btn" data-vvveb-action="saveAjax" data-actiontype="save-next">
                        Save &amp; Next
                        </button>
                    @endif
                </div>
                    ...
                    <div class="header">
                        <ul class="nav nav-tabs" id="elements-tabs" role="tablist">
                            ...
                            <li class="nav-item component-properties-tab" style="display:none">
                                <a class="nav-link" id="properties-tab" data-toggle="tab" href="#properties" role="tab" aria-controls="blocks" aria-selected="false">
        ...
        <script type="text/javascript">
            var uplevel ="../../../../editor/libs/builder/";
        </script>
        <!-- jquery-->
        ...
        <!--<script src="{{ asset('editor/libs/bootstrap-colorpicker/js/bootstrap-colorpicker.min.js')}}"></script>
        <link href="{{ asset('editor/libs/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css')}}" rel="stylesheet">
        <script src="{{ asset('editor/libs/builder/plugin-bootstrap-colorpicker.js')}}"></script>-->
        <!-- components-->
        <script src="{{ asset('editor/libs/builder/components-server.js')}}"></script>	
        <script src="{{ asset('editor/libs/builder/components-bootstrap4.js')}}"></script>	
        ...
        <!-- script src="editor/libs/jszip/jszip.min.js')}}"></script>
            <script src="editor/libs/builder/plugin-jszip.js')}}"></script -->
        ...
        <script>
            $(document).ready(function(){
                var panel = $('#filemanager');
                var body = $("body");
                var cssVar= "--builder-filemanager-height";
            	...
            	Vvveb.FileManager.addPages([<?php echo  $pages;?>]);            	
            	Vvveb.FileManager.loadPage("<?php echo $loadpage;?>");
            });
        </script>
    </body>
</html>