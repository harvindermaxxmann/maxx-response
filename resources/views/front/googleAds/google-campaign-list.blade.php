        ...
        <div class="container-fluid">
            ...
            <div class="planline page-title pad_top10">
                ...
                <ul class="nav navbar-nav navbar-right mar_bottom15">
                    <li>
                        <a class="btn btn-primary" href="{{url('/google-ads-campaign')}}">Create Google Ads Campaign</a>
                    </li>
                </ul>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-pie-chart"></i> Google Ads Campaigns</h3>
                        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td colspan="6" class="text-center">
                                    No Campaigns found. 
                                    <a href="{{url('/google-ads-campaign')}}" class="btn btn-primary btn-sm mar_left15"><i class="fa fa-plus-circle" aria-hidden="true"></i>
